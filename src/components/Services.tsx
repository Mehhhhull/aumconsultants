...
const services = [
  {
    ...
    description: "We help brands craft content strategies that convert insight into growth.",
    features: [
      "Brand Storytelling",
      "Content Planning",
  ...
  },
  {
    ...
    description: "We design meaningful digital experiences that strengthen brand identity.",
    features: [
  ...
  },
  {
    ...
    description: "Integrating creativity and technology for next-generation growth.",
    features: [
...
const additionalServices = [
  ...
  },
  {
    ...
    description: "Heritage and social-impact brands embracing digital transformation."
  }
];
      ...
      <div className="container-max">
        ...
        <div className="text-center mb-16 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            At AUM Consultants, we combine data-driven insights, creativity, and strategic consulting to help brands evolve into purpose-driven, future-ready organizations. By bridging strategy, storytelling, and technology, we create measurable impact for every client.
          </p>
        </div>
